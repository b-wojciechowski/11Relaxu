...
<body>
    ...
    color: darkgrey;">Poniżej przedstawione są dotychczasowe liczby głosów</p>
				...
				<div style="padding:10px 10px 5px 10px;">
					<div><i class="material-icons left">people</i>
						<h5><b>Bramkarze</b></h5>
					</div>
			...
			$sql = "select p.Id as Id, p.Name as Name, p.LastName as LastName, count(1) as Votes, p.Position as Position from votes as v 
					join players as p on p.id = v.VoteOnPlayerId 
					where Position = 'bramkarz' 
						and v.IsDeleted = 0  
					group by p.Id 
...
'<li>
	<div class="collapsible-header" style="padding:0px">
		<div class="collection-item avatar" style="width:100%" ;>
			...
			<p style="padding-left:10px; color:grey; margin-top:10px;"> <i class="material-icons left"
					style="margin-top:-2px; margin-right:0px!important;">star_border</i> Liczba głosów: '.$votes.'
