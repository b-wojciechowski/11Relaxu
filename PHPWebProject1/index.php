				...
				<form action="sendVotes.php" method="post">
								...
								'<li>
									<div class="collapsible-header" style="padding:0px">
										<div class="collection-item avatar" style="width:100%" ;>
											...
											<div style="padding-left:10px;padding-bottom:7px; padding-top:3px"> <span class="title">' .
													$bramkarz[1] . " " . $bramkarz[2] . '</span> </div>

											<p style="padding-left:10px;">

												<input class="goalkeeper-checkbox" type="checkbox" id="checkbox-' . $bramkarz[0] . '"
													name="goalkeeper[]" value="' . $bramkarz[0] . '" />
												<label style="padding-left:25px; font-weight: 300;  font-size: 13px;"
													class="playerCardCheckboxLabel" for="checkbox-' . $bramkarz[0] . '">' . $checkBoxLabelInfo .
													'</label>
									...
									<div class="collapsible-body">
										...
										<table class="striped" style="font-size:12px; margin-top:15px;">
											<tr>
												...
												<td class="">' . $bramkarz[1] . ' ' . $bramkarz[2] . '</td>
											</tr>
											<tr>
												<td class="">Pozycja:</td>
												<td class="">' . $bramkarz[3] . '</td>
											</tr>
											<tr>
												<td class="">Numer na koszulce:</td>
												<td class="">' . $bramkarz[4] . '</td>
											</tr>
											<tr>
												<td class="">Rok urodzenia:</td>
												<td class="">' . $bramkarz[13] . '</td>
											</tr>
											<tr>
												<td class="">Lata gry w Relaxie:</td>
												<td class="">' . $bramkarz[6] . '-' . $bramkarz[7] . '</td>
											</tr>
											<tr>
												<td class="">Dodatkowe pozycje:</td>
												<td class="">' . $bramkarz[11] . '</td>
											</tr>
								...
								'<li>
									<div class="collapsible-header" style="padding:0px">
										<div class="collection-item avatar" style="width:100%" ;>
											...
											<img class="circle" src="images/' . $playerImage . '" style="paddnig-right:10px;" />
											<div style="padding-left:10px;padding-bottom:7px; padding-top:3px"> <span class="title">' .
													$obronca[1] . " " . $obronca[2] . '</span> </div>

											<p style="padding-left:10px;">

												<input class="defender-checkbox" type="checkbox" id="checkbox-' . $obronca[0] . '"
													name="goalkeeper[]" value="' . $obronca[0] . '" />
												<label style="padding-left:25px; font-weight: 300;  font-size: 13px;"
													class="playerCardCheckboxLabel" for="checkbox-' . $obronca[0] . '">' . $checkBoxLabelInfo .
													'</label>
									...
									<div class="collapsible-body">
										...
										<table class="striped" style="font-size:12px; margin-top:15px;">
											<tr>
												<td class="" style="width:40%" ;>Imię i nazwisko:</td>
												<td class="">' . $obronca[1] . ' ' . $obronca[2] . '</td>
											</tr>
											<tr>
												<td class="">Pozycja:</td>
												<td class="">' . $obronca[3] . '</td>
											</tr>
											<tr>
												<td class="">Numer na koszulce:</td>
												<td class="">' . $obronca[4] . '</td>
											</tr>
											<tr>
												<td class="">Rok urodzenia:</td>
												<td class="">' . $obronca[13] . '</td>
											</tr>
											<tr>
												<td class="">Lata gry w Relaxie:</td>
												<td class="">' . $obronca[6] . '-' . $obronca[7] . '</td>
											</tr>
											<tr>
												<td class="">Dodatkowe pozycje:</td>
												<td class="">' . $obronca[11] . '</td>
											</tr>
										...
										<div class="collapsible-header" style="padding:0px">
											<div class="collection-item avatar" style="width:100%" ;>
												...
												<p style="padding-left:10px;">
													...
													<label style="padding-left:25px; font-weight: 300;  font-size: 13px;"
														class="playerCardCheckboxLabel" for="checkbox-' . $id . '">' . $checkBoxLabelInfo .
														'</label>
					...
					<div style="padding:5px 10px 10px 10px; ">
						...
						<div class="center">
							...
							<button class="btn waves-effect waves-light" type="submit" name="sendVotes.php">
								Prześlij swoją Jedenastkę
